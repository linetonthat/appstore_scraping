 ...
 * Build a "bonus" spider to scrape reviews for a given product on Amazon French website [https://github.com/linetonthat/appstore_scraping/blob/master/appstore/appstore/spiders/amazon_reviews.py]
